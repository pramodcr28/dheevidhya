...
export class NoticeAddComponent implements OnInit {
  ...
  const notice: Notice = {
      ...
      attendance: raw.attendance
        ...
        : undefined,
      examAnnouncement: raw.examAnnouncement
        ? {
            examTitle: raw.examAnnouncement.examTitle,
            examType: raw.examAnnouncement.examType,
            examStartDate: raw.examAnnouncement.examStartDate,
            examEndDate: raw.examAnnouncement.examEndDate
          }
        : undefined,
      examResult: raw.examResult
        ? {
            examTitle: raw.examResult.examTitle,
            examType: raw.examResult.examType, // plain string is okay here
      ...
      holiday: raw.holiday
        ? {
            ...
            holidayStartDate: raw.holiday.holidayStartDate,
            holidayEndDate: raw.holiday.holidayEndDate
          }
        : undefined,
      meeting: raw.meeting
        ? {
            meetingType: raw.meeting.meetingType as "PTM" | "Individual" | "Emergency" | "Progress" | "Staff",
            meetingDate: raw.meeting.meetingDate,
      ...
      fest: raw.fest
        ? {
            ...
            eventStartDate: raw.fest.eventStartDate,
            eventEndDate: raw.fest.eventEndDate,
      ...
      appreciation: raw.appreciation
        ...
        : undefined,
      schoolAchievement: raw.schoolAchievement
        ? {
            ...
            achievementDate: raw.schoolAchievement.achievementDate
          }
        : undefined
    };
