...
import { ExaminationDTO, ExamTypeLabels, ExamStatusLabels, ExamReport, ResultData } from '../../models/examination.model';
...
export class ReportsComponent {
  ...
  private updateCharts() {
    ...
    this.chartData = {
      ...
      datasets: [{
        data: [
          this.report.stats.passedStudents || 0,
          this.report.stats.failedStudents || 0,
          this.report.stats.notFoundStudents || 0
        ],
